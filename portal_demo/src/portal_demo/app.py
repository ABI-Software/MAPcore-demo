...
from portal_demo import mesheroutput
from portal_demo import backend
from portal_demo import my_session
...
bundle_js = get_distribution('portal_demo').get_metadata(
